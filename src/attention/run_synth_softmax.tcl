...
# Note: Softmax primarily uses accum_method2 (or 1 depending on internal mapping) and maybe DSP settings. 
# We keep generic args for compatibility with DSE calls but will only apply relevant ones.
...
set prefix_name   [expr {[llength $argv] > 18 ? [lindex $argv 18] : "softmax"}]
