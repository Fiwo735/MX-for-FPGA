...
set top         fasttwosum_adder_tree
set outputDir ./hw/synth_output
...
# Read sources
read_verilog    [glob ./hw/src/hdl/fasttwosum/*.sv]
read_verilog    [glob ./hw/src/hdl/parametrizable-floating-point-verilog/*.v]
read_verilog    [glob ./hw/src/hdl/common/*.sv]

read_xdc        [ glob ./hw/src/xdc/*.xdc ]
# Alternatively, you can just create the clock constraint here:
